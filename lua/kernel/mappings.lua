...
vim.keymap.set('n', '<leader>ce', vim.lsp.buf.hover, { desc = 'Show hover documentation' })
...
vim.keymap.set('n', '<leader>c[', vim.diagnostic.goto_prev, { desc = 'Go to previous diagnostic' })
vim.keymap.set('n', '<leader>c]', vim.diagnostic.goto_next, { desc = 'Go to next diagnostic' })
