return {
	...
	keys = {
		...
		-- Закрытие буферов
		{ "<leader>qx", "<Cmd>BufferLinePickClose<CR>",       desc = "Pick buffer to close" },  -- интерактивное закрытие (выбор буквой)
		{ "<leader>qc", "<Cmd>BufferLineCloseOthers<CR>",     desc = "Close other buffers" },   -- закрыть все, кроме текущего
		{ "<leader>qr", "<Cmd>BufferLineCloseRight<CR>",      desc = "Close buffers to the right" }, -- закрыть буферы справа
		{ "<leader>ql", "<Cmd>BufferLineCloseLeft<CR>",       desc = "Close buffers to the left" }, -- закрыть буферы слева
		-- Пины (закрепление)
		{ "<leader>qP", "<Cmd>BufferLineTogglePin<CR>",       desc = "Toggle pin" },            -- закрепить/открепить буфер
		-- Быстрый переход по номерам (если включены numbers = "ordinal")
		{ "<leader>q1", "<Cmd>BufferLineGoToBuffer 1<CR>",    desc = "Go to buffer 1" },
		{ "<leader>q2", "<Cmd>BufferLineGoToBuffer 2<CR>",    desc = "Go to buffer 2" },
		{ "<leader>q3", "<Cmd>BufferLineGoToBuffer 3<CR>",    desc = "Go to buffer 3" },
		{ "<leader>q4", "<Cmd>BufferLineGoToBuffer 4<CR>",    desc = "Go to buffer 4" },
		{ "<leader>q5", "<Cmd>BufferLineGoToBuffer 5<CR>",    desc = "Go to buffer 5" },
		{ "<leader>q6", "<Cmd>BufferLineGoToBuffer 6<CR>",    desc = "Go to buffer 6" },
		{ "<leader>q7", "<Cmd>BufferLineGoToBuffer 7<CR>",    desc = "Go to buffer 7" },
		{ "<leader>q8", "<Cmd>BufferLineGoToBuffer 8<CR>",    desc = "Go to buffer 8" },
		{ "<leader>q9", "<Cmd>BufferLineGoToBuffer 9<CR>",    desc = "Go to buffer 9" },
		-- Группы (если используются)
		{ "<leader>qg", "<Cmd>BufferLineGroup<CR>",           desc = "Manage groups" }, -- открыть меню групп (требует настройки групп)
		-- Сортировка (опционально)
		{ "<leader>qd", "<Cmd>BufferLineSortByDirectory<CR>", desc = "Sort by directory" }, -- сортировка по папке
		{ "<leader>qe", "<Cmd>BufferLineSortByExtension<CR>", desc = "Sort by extension" }, -- сортировка по расширению
	},
}
