...
require("luau-lsp").setup({
	-- BUG: FUCK U LUAU LSP
	-- def + dec works only in orig plugin files
	-- u still can use only def but u cant ur def + orig dec or orig def + ur dec
	-- types = {
	-- 	definition_files = {
	-- 		["@unc"] = vim.fn.expand("~/.config/nvim/unc/unc.d.luau"),
	-- 	},
	-- 	documentation_files = {
	-- 		["drawing"] = vim.fn.expand("~/.config/nvim/unc/docs/Drawing.json"),
	-- 	},
	-- },
	sourcemap = {
		enabled = false,
...
local right = {
	...
	},
	{
		...
		color = { fg = colors.green, bg = colors.thm, gui = "bold" },
	},
	{
		"fileformat",
		fmt = string.upper,
